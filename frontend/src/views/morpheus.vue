          ...
          <el-header height="65px" style="background: black; padding-right: 0; padding-left: 0">
            ...
            <el-popover
                ...
                <div class="tips-content"> 
                  ...
                  Morpheus [1] is a program synthesis algorithm that accepts multiple source tables and a target table as input and automatically outputs lines of R code to reflect the process of transformation.
                  We develop the MORPHEUS Revisited system, in which we apply Somnus [2] to explain the scripts generated by Morpheus. 
                  <h3 style="margin-bottom:10px;">Reference</h3>
                  [1] Yu Feng, Ruben Martins, Jacob Van Geffen, Isil Dillig, and Swarat Chaudhuri. Component-Based Synthesis of Table Consolidation and Transformation Tasks from Examples. ACM SIGPLAN Conference on
                  Programming Language Design and Implementation, 2017.<br>
                  [2] Kai Xiong, Siwei Fu, Guoming Ding, Zhongsu Luo, Rong Yu, Wei Chen, Hujun Bao, and Yingcai Wu. Visualizing the Scripts of Data Wrangling with SOMNUS. IEEE Transactions on Visualization and Computer Graphics, 2022.<br>
                  <a href="https://ieeexplore.ieee.org/document/9693232/" target="_blank">Somnus Paper</a><br>
                  <a href="/#/" target="_blank">Somnus System</a><br>
                  <a href="https://www.youtube.com/watch?v=fQ-eN_4vhso" target="_blank">Demo Video</a>
                </div>
                <span slot="reference">MORPHEUS&nbsp;Revisited</span>
              </el-popover>
            </div>
          </el-header>
          <div
